<?php
	// To create a specific Entity replace Bilancio with the name of the Entity that you need
	...
	*****************************************************************************************************************
    *	CLASS Bilancio																			 					*
	*		This class extends EntityBase. It's an object that representing the structure of Bilancio table in		*
	...
	*/
	...
	//		   with the function in BOBilancio class that you have to create finished to create this class
	class Bilancio extends EntityBase
	{
		// Insert here all the column of the table named Bilancio like properties
		public $idBilancio;
		public $saldo;
		public $scadenza;
	}
